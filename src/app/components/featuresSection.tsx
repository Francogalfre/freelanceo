  ...
  return (
    <section className="relative py-32 px-6 w-full overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center relative">
        <h2 className="text-6xl font-bold mb-16 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400">
          Features
        </h2>

        <div className="grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 grid gap-6 place-items-center">
